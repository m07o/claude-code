...
// E7: Force Pm() to return false
const e7Search = 'function Pm(){if(cU!==void 0)return cU;if(E7()!=="firstParty")return cU=Ce(!1);if(!WP())return cU=Ce(!1);if(process.env.CLAUDE_CODE_ENTRYPOINT==="local-agent")return cU=Ce(!1)';
...
if (bundleContent.includes(e7Search)) {
  ...
  log('OK', 'E7 - Pm() forced to return false');
  patchCount++;
} else {
  log('WARN', 'E7 - Pm() function not found with exact signature');
}
